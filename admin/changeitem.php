...
<table width="720" border="0" align="center" cellpadding="0" cellspacing="0">
	<p>&nbsp;</p>
  <tr>
    <td height="20" bgcolor="#FFCF60"><div align="center" class="style1">Edit item</div></td>
  </tr>
  <tr>
	...
	function chkinput(form)
	{
     ...
     <form name="form1" enctype="multipart/form-data" method="post" action="savechangeitem.php?id=<?php echo $_GET[id];?>" onSubmit="return chkinput(this)">
	  <tr>
      ...
      <tr>
        <td height="25" colspan="2" bgcolor="#FFFFFF"><div align="center"><input name="submit" type="submit" id="submit" value="Change">
